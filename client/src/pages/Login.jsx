        ...
        <div className="w-full max-w-[420px] mx-auto lg:mx-0 flex justify-center lg:justify-end">
          ...
          >
            ...
            <motion.div 
              ...
              className="mb-6"
            >
              <h1 className="text-[28px] font-bold text-[#1E293B] tracking-tight">Welcome Back! 👋</h1>
              <p className="text-[14px] text-[#94A3B8] mt-1.5">Login to continue to DJSphere</p>
            </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                ...
                <div className="flex justify-end mt-2">
                  <a href="#forgot" className="text-xs font-medium text-[#94A3B8] hover:text-[#4A9B68] transition-colors">
                    Forgot Password?
                  </a>
                </div>
              </motion.div>
            ...
            >
              ...
              <Link to="/signup" className="font-semibold text-[#4A9B68] hover:text-[#3F895A] hover:underline">
                Sign up
              </Link>
            </motion.p>
